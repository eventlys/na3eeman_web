...
export const ForBusiness = () => {
            ...
            features: [
                ...
                },
                {
                    ...
                    description: isRTL
                        ...
                        : 'Track and resolve customer-salon disputes transparently.',
                },
            ],
        },
        {
    ...
    return (
        <div className="pt-24 transition-colors duration-300">
            <section className="py-16 bg-cream dark:bg-[#0a0a0a] relative overflow-hidden" ref={ref}>
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    ...
                    >
                        <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
                            {isRTL ? 'نعيمًا للأعمال' : 'Na3eeman for Business'}
                        </h1>
                        <p className="section-subtitle max-w-2xl mx-auto">
                            {isRTL
                                ? 'كل ما تحتاجه لإدارة محلك. منصة متكاملة تضاهي أكبر الأنظمة العالمية وتفوقها بميزات مصممة للسوق العربي.'
                                : 'Everything you need to run your business. An all-in-one platform that rivals top global systems.'}
                        </p>
                    </motion.div>
                            ...
                            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                {cat.features.map((feat, fi) => (
                                    <motion.div
                                        ...
                                        className="group card backdrop-blur-xl"
                                    >
                                        <div className={`w-12 h-12 mb-6 rounded-xl bg-gradient-to-br ${cat.color} flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform duration-300`}>
                                            {feat.icon}
                                        </div>
                                        <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-3">{feat.title}</h4>
...
const SalaryIcon = () => ico(<><path strokeLinecap="round" strokeLinejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></>);
