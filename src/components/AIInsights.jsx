...
export const AIInsights = () => {
    ...
    return (
        <section id="ai" className="py-24 bg-white dark:bg-[#050505] transition-colors duration-300" ref={ref}>
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-100/50 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300 text-sm font-bold mb-6 backdrop-blur-sm border border-violet-200/50 dark:border-violet-800/50">
                        <span>✦</span>
                    ...
                    <p className="section-subtitle max-w-2xl mx-auto">
                        {isRTL
                            ? 'Na3eeman يحلّل بيانات محلك كل أسبوع ويقترح توصيات قابلة للتنفيذ.'
                            : 'Na3eeman analyses your salon data weekly and delivers actionable recommendations.'}
                    </p>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center relative">
                        ...
                        {insights.map((insight, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`${insight.bg} ${insight.border} border rounded-2xl p-5 flex gap-4 items-start group hover:shadow-md transition-all duration-300 backdrop-blur-md`}
                                >
                    ...
                    >
                        {/* Decorative glow */}
                        <div className="absolute inset-0 bg-gradient-to-br from-violet-500/20 to-blue-500/20 blur-3xl -z-10 rounded-full" />
                        
                        <div className="bg-gradient-to-br from-violet-600 to-blue-600 rounded-3xl p-10 text-white shadow-2xl relative overflow-hidden border border-white/10">
                            {/* Glass reflection */}
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-black mb-3 text-transparent bg-clip-text bg-gradient-to-r from-white to-white/80">
                                ...
                                <ul className="space-y-4">
                                    {[
                                        ...
                                        <li key={i} className="flex items-center gap-3">
                                            <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 backdrop-blur-sm">
